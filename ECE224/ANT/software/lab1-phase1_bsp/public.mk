...
JDI_FILE := C:/cygwin64/home/s244sing/ece2b-labs/ECE224/ANT/myESystem.jdi
...
# Design Name 
# setting SOPC_NAME is my_controller
SOPC_NAME := my_controller
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x10010d0
SOPC_SYSID_FLAG += --sidp=0x10010d0
ELF_PATCH_FLAG  += --sidp 0x10010d0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1378857897
SOPC_SYSID_FLAG += --timestamp=1378857897
ELF_PATCH_FLAG  += --timestamp 1378857897
